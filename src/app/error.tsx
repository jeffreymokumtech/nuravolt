  ...
  return (
    <>
      <div className="h-screen w-full flex flex-col justify-center items-center text-center gap-6 p-6">
        <div className="p-6 bg-paper rounded">
          <svg
        ...
        <p className="text-signal-critical">{error?.message}</p>

        <div className="flex flex-wrap gap-4 justify-center">
          <button className="inline-flex items-center gap-2 px-4 py-2 rounded border border-divider bg-paper text-ink hover:bg-paper-2" onClick={reset}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <Link href="/" className="inline-flex items-center gap-2 px-4 py-2 rounded border border-divider bg-paper text-ink hover:bg-paper-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
